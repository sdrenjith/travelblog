...
<button style={{borderRadius: '20px', borderWidth: '2px',marginLeft:'66px'}} type="button" class="btn btn-outline-warning">LEARN MORE</button>                 </div>
 ...
 <div>
           <div className="row">
            <div className="col-2"></div>
            <div className="col-3">
                <img width={'100%'} src="https://images.pexels.com/photos/3361818/pexels-photo-3361818.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
            </div>
            <div className="col-3">
                <img width={'100%'} src="https://media.istockphoto.com/id/544676786/photo/casablanca-mosque.jpg?b=1&s=612x612&w=0&k=20&c=cDPKsrjgN4e9o8sj-gtHaZGaPfvhpJ8lL1bD-Kejgdc=" alt="" />
            </div>
                        <div className="col-3">
                            <img width={'100%'} src="https://images.pexels.com/photos/3025835/pexels-photo-3025835.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        </div>
...
<h4  style={{marginLeft: '50px'}}>MAROCCO</h4>
<p style={{fontWeight:'1', marginLeft: '15px',fontSize: '10px'}}>It has become cliche to say that Argentina is as much European as it is Latin; yet to arrive in Buenos Aires and discover this is actually true still surprise</p>  
<button style={{borderRadius: '20px', borderWidth: '2px',marginLeft:'66px'}} type="button" class="btn btn-outline-warning">LEARN MORE</button>          </div>
                        <div className="col-3">
